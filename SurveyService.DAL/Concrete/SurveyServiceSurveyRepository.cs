...
namespace SurveyService.DAL.Concrete
{
    public class SurveyServiceSurveyRepository : ISurveyRepository
    {
        ...
        public async Task CreateRange(ICollection<Survey> item)
        {
            await context.Surveys.AddRangeAsync(item);
            await context.SaveChangesAsync();
        }
        ...
        public async Task DeleteRange(ICollection<Survey> item)
        {
            context.Surveys.RemoveRange(item);
            await context.SaveChangesAsync();
        }
