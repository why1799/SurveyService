...
namespace SurveyService.DAL.Concrete
{
    public class SurveyServiceOptionRepository : IOptionRepository
    {
        ...
        public async Task CreateRange(ICollection<Option> item)
        {
            await context.Options.AddRangeAsync(item);
            await context.SaveChangesAsync();
        ...
        public async Task DeleteRange(ICollection<Option> item)
        {
            context.Options.RemoveRange(item);
            await context.SaveChangesAsync();
        }
